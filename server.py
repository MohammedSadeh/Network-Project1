...
while True:
    ...
    if(request =="/" or request =="/index.html" or request =="/main_en.html" or request =="/en"):
        if 'main_en.html' in files:
            with open('main_en.html','r') as mainEn:
                mainEn = mainEn.read()
    ...
    #Arabic Version
        ...
        if 'main_ar.html' in files:
            with open('main_ar.html','rb') as mainAr:
                mainAr = mainAr.read()
            sendResponse(200,'text/html')
    ...
    #supporting material English
        ...
        if 'supporting_material_en.html' in files:
            with open('supporting_material_en.html','r') as supporting_En:
    ...
    #supporting material Arabic
        ...
        if 'supporting_material_ar.html' in files:
            with open('supporting_material_ar.html','rb') as supporting_Ar:
